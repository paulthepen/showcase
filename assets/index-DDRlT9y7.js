...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function Vu(){return new ci({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fc(),fragmentShader:`
		...
		`,blending:ri,depthTest:!1,depthWrite:!1})}function Gu(){return new ci({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fc(),fragmentShader:`
